...
import { SafeAreaView, Text, View, FlatList, Platform, StatusBar, StyleSheet, Alert, ImageBackground, Dimensions, Image } from 'react-native'
...
export default class MeteorScreen extends Component{
    ...
    getMeteors=()=>{
        axios
        .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=kBxeHSEzb7hyyZvhMETHdLDCyGT0LHRWZhFmQSI6")
        .then(response=>{
